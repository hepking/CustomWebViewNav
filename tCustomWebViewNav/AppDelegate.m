...
//    [self regNSURLProtocolScheme:YES];
    
    self.window = [[UIWindow alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
    
#if DEBUG_LOCAL
    NSString *path = [[NSBundle mainBundle] pathForResource:@"NSHipster.com" ofType:@"html"];
    H5ViewController *controller = [[H5ViewController alloc] initWithFileURL:[NSURL fileURLWithPath:path]];
#else
    H5ViewController *controller = [[H5ViewController alloc] initWithURL:[NSURL URLWithString:@"https://m.baidu.com/"]];
#endif
...
// 注册处理的
-(void)regNSURLProtocolScheme:(BOOL)enable{
